...
enum mctp_i3c_endpoint_state {
	MCTP_I3C_UNDEFINED,
	MCTP_I3C_AWAIT_VERSION_RESP,
	MCTP_I3C_AWAIT_SET_ENDPOINT_RESP,
	MCTP_I3C_AWAIT_MSG,
};
...
#define MCTP_I3C_CONTROLLER_DT_DEFINE(_name, _node_id)                                        \
	...
	static enum mctp_i3c_endpoint_state _name##_endpoint_states[DT_PROP_LEN(_node_id, endpoints)];              \
	static struct i3c_device_desc *_name##_endpoint_i3c_devs[DT_PROP_LEN(_node_id, endpoints)]; \
	static struct mctp_binding_i3c_controller _name = {                                   \
		...
		.endpoint_states = _name##_endpoint_states,                                   \
	};

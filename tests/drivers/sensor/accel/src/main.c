...
static void *sensor_accel_setup(void)
{
	...
	fixture.accel_0 = device_get_binding(DT_LABEL(DT_ALIAS(accel_0)));
	fixture.accel_1 = device_get_binding(DT_LABEL(DT_ALIAS(accel_1)));
	fixture.accel_emul_0 = emul_get_binding(DT_LABEL(DT_ALIAS(accel_0)));
	fixture.accel_emul_1 = emul_get_binding(DT_LABEL(DT_ALIAS(accel_1)));

	zassume_not_null(fixture.accel_0, NULL);
	zassume_not_null(fixture.accel_1, NULL);
	zassume_not_null(fixture.accel_emul_0, NULL);
	zassume_not_null(fixture.accel_emul_1, NULL);

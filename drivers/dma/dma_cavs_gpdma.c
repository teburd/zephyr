...
static void cavs_gpdma_en_clk(const struct device *dev)
{
...
int cavs_gpdma_init(const struct device *dev)
{
	...
	/* Setup clock/power gating appropriately before initializing */
	cavs_gpdma_en_clk(dev);

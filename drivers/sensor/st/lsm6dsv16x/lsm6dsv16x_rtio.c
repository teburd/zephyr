...
static void lsm6dsv16x_submit_sample(const struct device *dev,
...
void lsm6dsv16x_submit_sync(struct rtio_sqe *iodev_sqe)
{
	const struct sensor_read_config *cfg = iodev_sqe->iodev->data;
...
void lsm6dsv16x_submit(const struct device *dev, struct rtio_sqe *iodev_sqe)
{
